...
**这文件给谁看**：做 CME214（单元操作 II）题要画图时，AI 和我自己照着喂数据。
...
模板参考：`01_Projects/CME214_单元操作II/_drafts/L02_sle_example8/solution.md`（example-8 颜料洗涤完整解答）。

## 三句话总结

1. **这文件说了什么**：CME214 五种图解题，各有一个测好的画图函数，喂干净数据就出正确图。
2. **我什么时候回来看**：做单元操作 II 任何要画三元图 / 阶梯 / 干燥曲线 / 过滤线性图的题时。
